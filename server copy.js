...
// const outputFilePath = "filtered_wordlist.txt";
// fs.writeFileSync(outputFilePath, ""); // Clear the output file before appending new words
...
async function validateWords(words, lang) {
  ...
  for (const word of words.slice(0, 1000)) {
    ...
    // c = c + 1;
    // if (c % 50 === 0) {
    //   console.log((c * 100) / words.length);
    // }
  }
  // const outputFilePath = "filtered_wordlist.txt";
  // fs.writeFileSync(outputFilePath, validWords.join("\n"));
  return validWords;
}
...
// const wordListPath = path.resolve("wordlist.txt");
...
//   validateWords(wordsArray, "en_GB").then((e) => {
//     console.log(e);
//   });
// });
